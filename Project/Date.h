...
namespace sdds {
    ...
    protected:
        friend class Publication; //set publication as a protected friend 
    public:
        ...
        std::istream& read(std::istream& is = std::cin);//cin
        std::ostream& write(std::ostream& os = std::cout) const;//cout
